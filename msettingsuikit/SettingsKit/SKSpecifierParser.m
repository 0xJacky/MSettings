...
+(NSArray*)specifiersFromArray:(NSArray*)array forTarget:(PSListController*)target
{
    ...
    for (NSDictionary *dict in array)
    {
        ...
        if (cellType == PSGroupCell)
        {
                ...
                if (dict[@"footerCellClass"] != nil)
                    [spec setProperty:dict[@"footerCellClass"] forKey:@"footerCellClass"];
                if (dict[@"alignment"] != nil)
                    [spec setProperty:dict[@"alignment"] forKey:@"alignment"];
                if (dict[@"footerAlignment"] != nil)
                    [spec setProperty:dict[@"footerAlignment"] forKey:@"footerAlignment"];

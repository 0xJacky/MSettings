...
+(void) openSina:(NSString*)userName
{
    if ([[UIApplication sharedApplication] canOpenURL:[NSURL URLWithString:@"sinaweibo:"]])
        [[UIApplication sharedApplication] openURL:[NSURL URLWithString:[@"sinaweibo://userinfo?uid=" stringByAppendingString:userName]]];
	else
        [[UIApplication sharedApplication] openURL:[NSURL URLWithString:[@"http://m.weibo.cn/" stringByAppendingString:userName]]];
}

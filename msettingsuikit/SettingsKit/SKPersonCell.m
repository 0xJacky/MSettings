...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
	if((self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])){
        ...
        if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
            [label setFont:[UIFont fontWithName:@"HelveticaNeue-UltraLight" size:30]];
        else
            [label setFont:[UIFont fontWithName:@"HelveticaNeue-UltraLight" size:21]];
        ...
        [label2 setFont:[UIFont fontWithName:@"HelveticaNeue-UltraLight" size:13]];
